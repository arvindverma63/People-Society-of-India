    ...
    <main class="main">
        ...
        <div class="page-title dark-background" data-aos="fade"
            ...
            <div class="container position-relative">
                <h1>About Us</h1>
                <p>Join our mission to foster environmental sustainability, promote tree planting, and inspire a green
                    future for all.</p>
            ...
            <div class="container">
                <div class="row gy-4 justify-content-between align-items-center">
                    ...
                    <div class="col-lg-5 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p class="mb-4">
                            At the People Society of India, we believe that planting trees is more than an act of
                            reforestation; it’s a pledge to a healthier planet. Together, we can build a green and
                            sustainable future.
                        </p>
                        <ul class="list-unstyled list-check">
                            <li>Encourage community participation in tree planting</li>
                            <li>Promote sustainable practices for a better tomorrow</li>
                            <li>Inspire a global movement towards reforestation</li>
                        </ul>
                    ...
                    <div class="row g-0">
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>
                                        Our planting services focus on sustainable methods to enhance greenery and
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    <p>
                                        Enhance soil health and retain moisture with our high-quality mulching services,
                                        designed for long-term plant growth.
                                    </p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>
                                        Keep your lawn pristine with our expert mowing services, ensuring a clean and
                                        even cut for a beautifully maintained landscape.
                                    </p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>
                                        Enhance your garden or lawn with our professional seeding services, ensuring
                                        healthy growth and a lush, green environment for your outdoor spaces.
                                    </p>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>
                                        Discover the taste of freshness with our handpicked vegetables, cultivated with
                                        care to ensure premium quality and nutrition for your family.
                                    </p>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>
                                        Ensure vibrant growth and lush greenery with our efficient watering solutions,
                                        designed to nourish plants and conserve resources effectively.
                                    </p>
                                </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <p class="opacity-50">
                                Stay updated with our latest news, tips, and special offers. Join our community today!
                            </p>
                        </div>
                        <div class="col-lg-6">
                            <form action="forms/newsletter.php" class="form-subscribe php-email-form" method="post">
                                <div class="form-group d-flex align-items-stretch">
                                    <input type="email" name="email" class="form-control h-100"
                                        placeholder="Enter your email address" required>
                                    <button type="submit" class="btn btn-secondary px-4">Subscribe</button>
                                </div>
                                <div class="loading">Loading...</div>
                                <div class="error-message"></div>
                                <div class="sent-message">
                                    Thank you for subscribing! We've added you to our list.
                                </div>
                            </form>
                        </div>
                    </div>
