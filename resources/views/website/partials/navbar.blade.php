<div class="bg-white p-1 p-lg-2">
    <div class="container">
        <div class="d-flex justify-content-end align-items-center"><a class="ms-2 ms-md-3 submenu"
                ...
                href="#!"><span class="uil uil-user-circle"></span><span
...
<nav class="navbar navbar-expand-lg py-1" id="navbar-top" data-navbar-soft-on-scroll="data-navbar-soft-on-scroll">
    <div class="container"><a class="navbar-brand me-lg-auto cursor-pointer" href=""><img class="w-md-100 img-fluid" src="assets/img/logos/logo2.png" style="height: 70px; width: auto;" alt="" /></a>
